  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div 
          ref={leftPanelRef}
          className="relative hidden md:flex flex-col justify-end border border-[#E6D0AC]/20 rounded-l-2xl overflow-hidden min-h-[650px]"
        >
          {/* Background Image */}
          <div 
        ...
        <div 
          ref={rightPanelRef}
          className="flex flex-col items-center justify-center border border-[#E6D0AC]/20 md:border-l-0 rounded-2xl md:rounded-l-none md:rounded-r-2xl bg-[#1A1A1A]/90 backdrop-blur-xl px-6 py-10 md:px-12 md:py-12 min-h-[650px]"
        >
          {/* Logo */}
          ...
          {/* Heading */}
          <div ref={addToRefs} className="w-full max-w-sm mb-6">
          ...
          {/* Form Fields */}
          <div ref={addToRefs} className="w-full max-w-sm flex flex-col gap-3.5 mb-4">
            <div className="w-full bg-[#2A2A2A]/80 border border-[#3A3A3A] rounded-xl px-5 py-3.5 transition-all focus-within:border-[#E6D0AC]/40 focus-within:bg-[#2A2A2A]">
              <input 
                type="text" 
            ...
            <div className="w-full bg-[#2A2A2A]/80 border border-[#3A3A3A] rounded-xl px-5 py-3.5 flex items-center transition-all focus-within:border-[#E6D0AC]/40 focus-within:bg-[#2A2A2A]">
              <input 
            ...
            <div className="w-full bg-[#2A2A2A]/80 border border-[#3A3A3A] rounded-xl px-5 py-3.5 flex items-center transition-all focus-within:border-[#E6D0AC]/40 focus-within:bg-[#2A2A2A]">
              <input 
                ...
                className="w-full bg-transparent text-champagne placeholder-champagne/40 outline-none font-sans text-base"
              />
              <button onClick={() => setShowPassword(!showPassword)} className="text-champagne/40 hover:text-champagne transition-colors ml-2">
          ...
          {/* Social Buttons */}
          <div ref={addToRefs} className="w-full max-w-sm flex gap-4 mb-6">
            <button 
              onClick={() => googleLogin()} 
          ...
          <div ref={addToRefs} className="w-full max-w-sm text-center">
            <p className="font-serif text-champagne/60 text-sm">
              Already Have an Account? <button onClick={onLoginClick} className="text-champagne underline underline-offset-2 hover:text-[#E6D0AC] transition-colors">Login</button>
            </p>
          </div>
        </div>
      </div>
